...
class ViewController: UITableViewController, SLRefreshViewDelegate {
    
    var refreshView: SLRefreshView!
    ...
    override func viewDidLoad() {
        ...
        refreshView = SLRefreshView(frame: refreshRect, scrollView: self.tableView)
